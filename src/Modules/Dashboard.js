        ...
        render() {
            return (
                <Grid fluid="true">
                  ...
                  <Row id="nonFluid">
                    <Col md={3}>
                      <Tile containerId="drillingTile" streamType="machine" streamId="DRILLING_SPEED" borders="5, 10, 15, 17.5" colors="#1e90ff,#00bfff,#60B044,#F6C600,#FF0000" icon="https://d30y9cdsu7xlg0.cloudfront.net/png/170362-200.png" value="0" unit="T RPM" title="Drilling Speed" status="stopped"></Tile>
                    </Col>
                    <Col md={3}>
                      <Tile containerId="drillingTile2" streamType="machine" streamId="DRILLING_HEAT" borders="50, 100, 150, 200" colors="#1e90ff,#00bfff,#60B044,#F6C600,#FF0000" icon="https://d30y9cdsu7xlg0.cloudfront.net/png/170362-200.png" value="0" unit="°C" title="Drilling Heat" status="stopped"></Tile>
                    </Col>
                    <Col md={3}>
                      <Tile containerId="millingTile" streamType="machine" streamId="MILLING_SPEED" borders="5, 10, 15, 17.5" colors="#1e90ff,#00bfff,#60B044,#F6C600,#FF0000" icon="http://www.freeiconspng.com/uploads/mill-icon-16.png" value="0" unit="T RPM" title="Milling Speed" status="stopped"></Tile>
                    </Col>
                    <Col md={3}>
                      <Tile containerId="millingTile2" streamType="machine" streamId="MILLING_HEAT" borders="50, 100, 150, 200" colors="#1e90ff,#00bfff,#60B044,#F6C600,#FF0000" icon="http://www.freeiconspng.com/uploads/mill-icon-16.png" value="0" unit="°C" title="Milling Heat" status="stopped"></Tile>
                    </Col>
                    <Col md={3}>
